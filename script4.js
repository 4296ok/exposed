...
// Use remote file
video.src = 'Students/celine/video.mp4';
...
const textNode = document.createTextNode("Dichotomy by Céline Bregman, fashion graduate");
...
for(let i = 1; i < 7; i++) {
  let fn = "Students/celine/studio_" + i + ".jpg";
...
for(let i = 1; i < 17; i++) {
let fn = "Students/celine/runway_" + i + ".jpg";
